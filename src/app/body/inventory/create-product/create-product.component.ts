...
export class CreateProductComponent implements OnInit {
  ...
  constructor(public functions: AngularFireFunctions, private modalService: NgbModal, private toastService: ToastService) { }
  ...
  async createNewProduct() {
    ...
    try {
      const result = await callable({ Mode: "CREATE", Name: this.productName, Description: this.productDescription, Availability: this.productAvailability, ActualPrice: this.productActualPrice, DiscountPrice: this.productDiscountPrice, Visibility: this.productVisibility }).toPromise();
